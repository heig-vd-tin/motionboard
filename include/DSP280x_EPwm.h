...
// CTRMAX
#define PWM_CTRMAX_CLEAR_LATCHED_EVENT 	1

// SYNCI
#define PWM_SYNCI_CLEAR_LATCHED_EVENT 	1

// CHPEN
#define PWM_CHPEN_DISABLE_CHOPPING		0
#define PWM_CHPEN_ENABLE_CHOPPING		1

// OTSFA
#define PWM_OTSFA_INIT_SW_EVENT			1

// ACTSFB
#define PWM_ACTSFB_ACTION_DISABLED		0
#define PWM_ACTSFB_CLEAR				1
#define PWM_ACTSFB_SET					2
#define PWM_ACTSFB_TOGGLE				3 

// OST
#define PWM_OST_DISABLE_TRIP_ZONES		0
#define PWM_OST_ENABLE_TRIP_ZONES		1

// CBC
#define PWM_CBC_DISABLE_INTERRUPT		0
#define PWM_CBC_ENABLE_INTERRUPT		1

// INT
#define PWM_INT_NO_INTERRUPT			0
#define PWM_INT_INTERRUPT_WAS_GENERATED 1
