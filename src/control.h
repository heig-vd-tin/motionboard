...
static inline void direct_clarke_park(float u1, float u2, float *y1, float *y2,
                                      float theta)
{
...
static inline void inverse_park_clarke(float isd, float isq, float *ya,
                                       float *yb, float *yc, float theta)
{
