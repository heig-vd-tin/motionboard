...
#include "common.h"  // Examples Include File
#include "device.h"  // Headerfile Include File
...
void ConfigCpuTimer(struct CPUTIMER_VARS *Timer, float Freq, float Period)
{
    ...
    Timer->RegsAddr->TCR.bit.TSS =
        1;  // 1 = Stop timer, 0 = Start/Restart Timer
    Timer->RegsAddr->TCR.bit.TRB = 1;  // 1 = reload timer
    Timer->RegsAddr->TCR.bit.SOFT = 1;
    Timer->RegsAddr->TCR.bit.FREE = 1;  // Timer Free Run
    Timer->RegsAddr->TCR.bit.TIE =
        1;  // 0 = Disable/ 1 = Enable Timer Interrupt
